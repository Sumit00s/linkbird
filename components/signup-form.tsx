    ...
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <Card>
        <CardHeader className="text-center">
          <CardTitle className="text-xl">Welcome to LinkBird</CardTitle>
          <CardDescription>
            Create with your Google account
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Your Name" {...field} type="name"/>
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                />
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="mr@example.com" {...field} type="email"/>
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
